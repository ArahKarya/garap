...
-- CreateEnum
CREATE TYPE "LinkPlatform" AS ENUM ('GOOGLE_DRIVE', 'GITHUB', 'FIGMA', 'NOTION', 'YOUTUBE', 'GENERIC');

-- CreateEnum
CREATE TYPE "TaggableEntity" AS ENUM ('TASK', 'PROJECT', 'LINK', 'NOTE', 'DOCUMENT');
...
CREATE TABLE "links" (
    ...
    "favicon_url" TEXT,
    "thumbnail_url" TEXT,
    "platform" "LinkPlatform" NOT NULL DEFAULT 'GENERIC',
    "notes" TEXT,
...
CREATE TABLE "entity_tags" (
    ...
    "entity_type" "TaggableEntity" NOT NULL,
...
-- CreateIndex
CREATE INDEX "file_uploads_entity_entityId_idx" ON "file_uploads"("entity", "entityId");
...
-- CreateIndex
CREATE INDEX "links_platform_idx" ON "links"("platform");
...
-- CreateIndex
CREATE UNIQUE INDEX "documents_file_upload_id_key" ON "documents"("file_upload_id");
